# SnapIt
SnapIt uses [Svelte 5](https://svelte.dev) & SvelteKit. For styling, [Tailwind](https://tailwindcss.com) is used together with [Shadcn-svelte](https://www.shadcn-svelte.com).
